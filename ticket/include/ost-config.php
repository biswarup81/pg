...
define('SECRET_SALT','5b1e2a713269eb392d35b7680c816492');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','pginfoservices@yahoo.com');
...
define('DBNAME','pginfose_ticket');
define('DBUSER','pginfose_ticket');
define('DBPASS','.Pr4)4eS9c');

# Table prefix
define('TABLE_PREFIX','ticket_');
