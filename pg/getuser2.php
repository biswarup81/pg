...
echo "<table border='0' cellpadding='4' cellspacing='2' style='border solid 1px #ccc' >
		<tr>
		<td colspan='2' align='center' class='back_table'>Complain No : ".$row['complain_no']."</td>
		</tr>
  		<tr>
		...
		<tr>
            <th class='back_table'>Resolved Comments</td>
            <td>".$row['resolved_comment']."</td>
          </tr>
                <tr>
		<th class='back_table'>Closed Comment </th>
                <td><textarea rows='2' cols='100' name ='closed_comment'></textarea></td>
		</tr>
                <tr>
                <td colspan='2' style='text-align: center;'>
                    <input type='hidden' name='key' value='close' />
                    <input type='submit' name='check' value='Close'>
                </tr>";
